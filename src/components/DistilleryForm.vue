...
<template>
  <RecordForm :record="distillery" :endpoint="endpoint" :method="method" @save="handleSave">
    ...
    <template #form="{ record }">
      <v-form>
        ...
        <SelectFromRequest path="regions" key="name" name="region_id" v-model="record.region_id" />
      </v-form>
    </template>
  </RecordForm>
</template>
